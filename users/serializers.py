...
class UserSerializer(serializers.ModelSerializer):
    ...
    def validate_first_name(self, value):
        ...
        if not name_regex.match(value):
            raise serializers.ValidationError({"first_name": ["First Name should only contain alphabetical characters."]})
        return value
    ...
    #             {"email": ["Only emails ending with @gmail.com are allowed."]}
    #         )
    #     return value
